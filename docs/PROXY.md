...
| **Blinkit** | **Mac Pro residential session, auth-required** | Production uses `/Users/danny./VPS-Migration/scripts/run_blinkit_mac_to_vps.sh` under LaunchAgent `com.danny.blinkit-mac-to-vps` at 03:45 IST. It loads `/Users/danny./VPS-Migration/secrets/blinkit-auth-state.json`, exports `BLINKIT_REQUIRE_AUTH=1`, and VPS ingest defaults to `BLINKIT_REQUIRE_AUTH_DROP=1`. Do not run or accept anonymous Blinkit drops; `summary.auth_session` and `summary.auth_required` must be present/truthy. |
