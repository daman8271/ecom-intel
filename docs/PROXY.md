...
| **Blinkit** | **Mac Pro residential session, auth-required** | Production uses `/Users/danny./VPS-Migration/scripts/run_blinkit_mac_to_vps.sh` under LaunchAgent `com.danny.blinkit-mac-to-vps` at 06:30 IST. It loads `/Users/danny./VPS-Migration/secrets/blinkit-auth-state.json`, exports `BLINKIT_REQUIRE_AUTH=1`, `BLINKIT_OOS_PROBE=1`, and `BLINKIT_PDP_OOS_PROBE=1`, and VPS ingest defaults to `BLINKIT_REQUIRE_AUTH_DROP=1`. Do not run or accept anonymous/unprobed Blinkit drops; `summary.auth_session`, `summary.auth_required`, `summary.oos_probe_enabled`, and `summary.pdp_oos_probe_enabled` must be present/truthy. |
