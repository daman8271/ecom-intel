...
BLINKIT_REQUIRE_PDP_PRICE_PROBE_ENABLED="${BLINKIT_REQUIRE_PDP_PRICE_PROBE_ENABLED:-1}"
...
export BLINKIT_REQUIRE_OOS_PROBE_ENABLED BLINKIT_REQUIRE_PDP_OOS_PROBE_ENABLED BLINKIT_REQUIRE_PDP_PRICE_PROBE_ENABLED BLINKIT_ALLOW_LEGACY_REPAIRED_OOS
...
if env_bool("BLINKIT_REQUIRE_PDP_PRICE_PROBE_ENABLED", "1") and not flag_is_one(s.get("pdp_price_probe_enabled")):
    raise SystemExit(
